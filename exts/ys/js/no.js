$(function(){ //页面加载完毕才执行
    ...
    //图片路径/链接(数组形式):
    var images_url = IMAGES_FOR_BACKGROUND;
    ...
    dianji= function(s,num){
        ...
        // window.open(INDEX_URL_JS+"/exts/carousel1/carousel.html?id="+s+"&jsurl="+HOUSINGDETAIL_URL_JS, '_self');
        window.open("/index/swiper/index.html?id="+s+"&prop="+num+"", '_self');
    }
